...
<head>
    ...
    <title>Home &mdash; BK ESEMKITA</title>
        ...
        <div class="main-wrapper container">
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                <div class="container">
                    ...
                    <div class="nav-collapse">
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item active"><a href="#" class="nav-link">Esemkita Konseling</a></li>
                        </ul>
                    </div>
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2024 <div class="bullet"></div> SMKN 1 BOYOLANGU</a>
                </div>
