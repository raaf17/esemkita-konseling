            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center pb-3" data-toggle="tab" href="#table_processed">
                                Diproses <span class="btn btn-sm btn-success fw-bold ms-2 fs-8 py-2 px-2 ml-1"><?= $count_status_approve ?></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center pb-3" data-toggle="tab" href="#table_rejected">
                                Ditolak <span class="btn btn-sm btn-danger fw-bold ms-2 fs-8 py-2 px-2 ml-1"><?= $count_status_unapprove ?></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center pb-3" data-toggle="tab" href="#table_done">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="table_masuk" role="tabpanel">
                            <table class="table table-striped" id="data_laporan_pending">
                                <thead>
                                    <tr>
                                        <th width="5%">
                        ...
                        <div class="tab-pane fade" id="table_processed" role="tabpanel">
                            <table class="table table-striped" id="data_laporan_processed">
                                <thead>
                                    <tr>
                                        <th width="5%">
                                            <div class="custom-checkbox custom-control">
                        ...
                        <div class="tab-pane fade" id="table_rejected" role="tabpanel">
                            <table class="table table-striped" id="data_laporan_rejected">
                                <thead>
                                    <tr>
                                        <th width="5%">
                                            <div class="custom-checkbox custom-control">
                        ...
                        <div class="tab-pane fade" id="table_done" role="tabpanel">
                            <table class="table table-striped" id="data_laporan_done">
                                <thead>
                                    <tr>
                                        <th width="5%">
                                            <div class="custom-checkbox custom-control">
