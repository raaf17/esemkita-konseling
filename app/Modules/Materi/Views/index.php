    ...
    <div class="col-lg-7">
        <div class="card">
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="button" class="btn btn-sm btn-light-success me-3 btn-flex btn-center" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#import-materi-modal">
                                        Import
                                    </a>
                                </div>
                            </div>
            ...
            <div class="card-body pt-0 table-responsive">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-4" id="data_materi">
                    <thead>
