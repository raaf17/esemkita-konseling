<div class="modal fade" tabindex="-1" id="add-kunjunganrumah-modal">
...
<div class="modal fade" tabindex="-1" id="edit-kunjunganrumah-modal">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content" style="width: 800px; left: 50%; transform: translateX(-50%)">
            <div class="modal-header">
...
<div class="modal fade" id="detail-kunjunganrumah-modal" tabindex="-1">
    <div class="modal-dialog modal-dialog-scrollable">
...
<div class="modal fade" tabindex="-1" id="filter-tanggal-kunjungan-rumah-modal">
