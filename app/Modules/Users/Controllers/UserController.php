    ...
    public function listData()
    {
        ...
        if ($request->getMethod(true) == 'POST') {
            ...
            foreach ($lists as $list) {
                ...
                $buttonEdit = '<div class="d-flex"><a href="#" class="btn btn-sm btn-light-warning btn-action edit-users-btn p-0 p-2 me-2" data-id="' . $list->id . '"><i class="ki-outline ki-notepad-edit fs-4"></i></a>';
                $buttonDelete = '<a href="#" class="btn btn-sm btn-light-danger delete-users-btn p-0 p-2" data-id="' . $list->id . '"><i class="ki-outline ki-basket fs-4"></i></a></div>';
